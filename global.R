...
fields <- c("NCTId",'Phase','StartDate','StartDateType','CompletionDate',"BriefTitle","BriefSummary","Condition",'Keyword',"LocationCity",'LocationState','LocationZip','LocationCountry','OverallStatus','LeadSponsorName','LeadSponsorClass')
